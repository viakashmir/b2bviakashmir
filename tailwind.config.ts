  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'primary-fixed': '#a9d9b8',
        'primary-fixed-dim': '#8ec29e',
        'on-primary': '#ffffff',
        'on-primary-container': '#88bd95',
        'on-primary-fixed-variant': '#1d5031',
        secondary: '#13677b',
        'secondary-container': '#b9e2ea',
        'secondary-fixed': '#c3e6ec',
        'on-secondary-container': '#18697e',
        tertiary: '#4a2400',
        'tertiary-container': '#6b3600',
        'tertiary-fixed': '#f3d7bf',
        'tertiary-fixed-dim': '#e2a672',
        'on-tertiary-container': '#dc9257',
