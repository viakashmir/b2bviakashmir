    ...
    return (
      <main>
        <div style={{ minHeight: '60vh', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 700, color: '#00361a', opacity: 0.5 }}>Loading your listing…</div>
        </div>
      </main>
    )
  }
        ...
        <div className="card-elevated" style={{ padding: 24 }}>
            ...
            {[
              ...
              <div key={row.label} style={{ display: 'grid', gridTemplateColumns: '40px 1fr', gap: 12, alignItems: 'center' }}>
                ...
                <div>
                  ...
                  <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 14, fontWeight: 600, color: '#191c1d', overflowWrap: 'anywhere' }}>
                    {row.value}
                  </div>
                </div>
              </div>
          ...
          {hotel.description && (
            <div style={{ marginTop: 20, paddingTop: 18, borderTop: '1px solid #edeeef' }}>
              ...
              <p style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 13.5, color: '#414942', lineHeight: 1.6, margin: 0 }}>
                {hotel.description}
              </p>
            </div>
          )}
