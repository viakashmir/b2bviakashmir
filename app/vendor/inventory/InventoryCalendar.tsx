    ...
    return (
      <>
        <div style={{ minHeight: '100vh', background: '#f8f9fa', display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
          <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 700, color: '#00361a', opacity: 0.5 }}>Loading calendar…</div>
        </div>
      </>
    )
  }
      ...
      <>
        <main>
          <div className="card-elevated" style={{ padding: 28 }}>
            <p style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', color: '#414942' }}>
      ...
      <>
        <main>
          ...
          <div className="card-elevated" style={{ padding: 48, textAlign: 'center', maxWidth: 560, margin: '0 auto' }}>
            ...
            <h2 style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 800, color: '#00361a', margin: '0 0 10px' }}>
              No rooms in your listing yet
            </h2>
            <p style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 14, color: '#414942', lineHeight: 1.55, margin: '0 0 24px' }}>
    ...
    <>
      <main>
        ...
        <div className="card-elevated" style={{ padding: 18, marginBottom: 12, display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: 12 }}>
          <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 800, color: '#00361a', letterSpacing: '-0.02em' }}>
        ...
        <div className="card-elevated" style={{ padding: 16, marginBottom: 24 }}>
          ...
          {/* Legend */}
          <div style={{ marginTop: 16, display: 'flex', flexWrap: 'wrap', gap: 14, fontSize: 11, color: '#414942', fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontWeight: 600 }}>
            {([
          ...
          <div className="card-elevated" style={{ padding: 24, marginBottom: 32 }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
              <div>
                ...
                <h2 style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 800, color: '#00361a', margin: 0 }}>
                  {new Date(selected.date).toLocaleDateString('en-IN', { weekday: 'long', day: 'numeric', month: 'long', year: 'numeric' })}
                </h2>
                <p style={{ fontSize: 13, color: '#717971', margin: '4px 0 0', fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontWeight: 500 }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(220px, 1fr))', gap: 10, marginBottom: 16 }}>
              {selected.rooms.map(r => (
                <div key={r.id} style={{ background: '#f3f4f5', padding: 12, borderRadius: 10, fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif' }}>
                  <div style={{ fontSize: 12, fontWeight: 700, color: '#191c1d' }}>{r.type}</div>
                  <div style={{ display: 'flex', alignItems: 'baseline', gap: 8, marginTop: 4 }}>
                    <span style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 800, color: r.available === 0 ? '#93000a' : r.available <= 2 ? '#6f3800' : '#1d5031' }}>
                      {r.available}
                    </span>
          ...
          <div className="card-elevated" style={{ width: '100%', maxWidth: 480, padding: 28, animation: 'fade-up 0.25s ease' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', marginBottom: 16 }}>
              <div>
                ...
                <h3 style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 20, fontWeight: 800, color: '#00361a', margin: 0 }}>
                  Block date range
                </h3>
              </div>
                ...
                {([
                  ...
                  <button
                    ...
                    style={{
                      ...
                      fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 11.5, fontWeight: 700,
