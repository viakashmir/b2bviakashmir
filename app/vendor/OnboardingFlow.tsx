    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10, color: '#00361a' }}>
          ...
          <span style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontWeight: 800, fontSize: 16, letterSpacing: '-0.01em' }}>
            Via Kashmir
          </span>
          <span style={{
        ...
        >
                  ...
                  return (
                    <button
                      ...
                      style={{
                        ...
                        fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontWeight: 800,
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
                ...
                <div>
                  <label style={{
                    ...
                    marginBottom: 8, fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif',
          ...
          {step.key === 'review' && (
            <Prompt title="Ready to publish your listing?" subtitle="Looks right? Hit Publish, your listing goes live after admin approval.">
              <div style={{ background: '#ffffff', borderRadius: 18, padding: 24, boxShadow: '0 12px 40px rgba(0,54,26,0.08)' }}>
                <div style={{ display: 'grid', gridTemplateColumns: '130px 1fr', gap: '8px 18px', fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 14 }}>
              ...
              <p style={{ marginTop: 14, fontSize: 12.5, color: '#717971', fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', textAlign: 'center' }}>
          ...
          {error && (
            <p style={{
              ...
              fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', display: 'flex', alignItems: 'center', gap: 8,
            }}>
      ...
      <div style={{
        ...
        <button
          ...
          style={{
            ...
            fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontWeight: 700, fontSize: 13,
        ...
        <button
          ...
          style={{
            ...
            fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontWeight: 800, fontSize: 14,
            display: 'inline-flex', alignItems: 'center', gap: 8,
...
function Prompt({ title, subtitle, children }: { title: string; subtitle?: string; children: React.ReactNode }) {
  return (
    <div>
      <h2 style={{
        fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 'clamp(28px, 4vw, 38px)',
  ...
  return (
    <input
      ...
      style={{
        ...
        fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 26, fontWeight: 600,
...
function PhoneInputIN({ inputRef, value, onChange }: {
  ...
  return (
    <div style={{
      ...
      <span style={{
        fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 26, fontWeight: 700,
      ...
      />
      <span style={{
        fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 11, fontWeight: 700,
  ...
  return (
    <input
      ...
      style={{
        ...
        background: 'transparent',
        border: 'none', borderBottom: '2px solid rgba(0,54,26,0.18)',
        fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 60, fontWeight: 800,
    ...
    <>
      <textarea
        ...
        style={{
          ...
          border: 'none', borderBottom: '2px solid rgba(0,54,26,0.18)',
          fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 19, fontWeight: 500,
          color: '#00361a', padding: '10px 0', outline: 'none',
        ...
        return (
          <button
            ...
            style={{
              ...
              background: active ? 'linear-gradient(135deg, #00361a, #1a4d2e)' : '#ffffff',
              color: active ? '#ffffff' : '#191c1d',
              fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', cursor: 'pointer',
    ...
    <div style={{
      ...
      <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'baseline', flexWrap: 'wrap', gap: 8, marginBottom: 12 }}>
        <div>
          ...
          <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 800, lineHeight: 1.2, marginTop: 8, letterSpacing: '-0.01em' }}>
            {mood}
          </div>
        </div>
...
const kbd: React.CSSProperties = {
  ...
  borderRadius: 6, fontSize: 11, fontWeight: 700, fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif',
  color: '#414942',
}
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <span style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 14, fontWeight: 800, color: '#00361a', letterSpacing: '-0.01em' }}>
      ...
      <div style={{ flex: 1, position: 'relative' }}>
        {prefix && (
          <span style={{
            ...
            color: '#9aa19f', fontWeight: 600, fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 13,
            pointerEvents: 'none',
          }}>{prefix}</span>
        )}
        <input
          ...
          style={{
            ...
            fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 14, fontWeight: 700, color: '#191c1d',
            textAlign: 'center',
          }}
        />
      </div>
...
const stepperBtn: React.CSSProperties = {
  ...
  fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontWeight: 800, fontSize: 18,
  color: '#00361a',
...
function TariffWindow({ start, end, onStart, onEnd }: {
  ...
  return (
    <div>
      ...
      <div style={{ marginTop: 12, fontSize: 12, color: '#717971', fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif' }}>
...
const tfLabel: React.CSSProperties = {
  ...
  color: '#717971', marginBottom: 5, fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif',
}
