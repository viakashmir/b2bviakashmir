      ...
      <main className="app-shell">
        ...
        {tab === 'raise' && (
          <div className="card-elevated" style={{ padding: 28, maxWidth: 720 }}>
            <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 22, fontWeight: 700, color: '#00361a', marginBottom: 6 }}>Raise a Concern</div>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
            {myConcerns.length === 0 ? (
              ...
              <div key={c.id} className="card-elevated" style={{ padding: 22 }}>
                ...
                <p style={{ fontSize: 13.5, color: '#414942', fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', lineHeight: 1.6, margin: '12px 0 14px' }}>{c.description}</p>
                {c.adminResponse && (
