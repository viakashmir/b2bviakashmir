      ...
      >
        ...
        <nav style={{ flex: 1, padding: '8px 14px', display: 'flex', flexDirection: 'column', gap: 4 }}>
          ...
          <Link href="/" onClick={() => setOpen(false)} style={{ textDecoration: 'none' }}>
            <div style={{
              ...
              fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 13.5, fontWeight: 500,
            }}>
        ...
        <div style={{
          ...
          <div style={{ minWidth: 0, flex: 1 }}>
            <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 13, fontWeight: 700, color: '#ffffff', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap' }}>
              {displayName}
            </div>
            <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 10.5, color: 'rgba(255,255,255,0.55)', overflow: 'hidden', textOverflow: 'ellipsis', whiteSpace: 'nowrap', marginTop: 2 }}>
              {email}
            </div>
          </div>
          <button
