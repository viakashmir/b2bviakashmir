  ...
  return (
    <section className="kashmir-live" style={{
      ...
      <div className="card-elevated" style={{
        ...
        <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 30, fontWeight: 800, letterSpacing: '-0.02em', lineHeight: 1.05, marginTop: 6 }}>
          {time}
        </div>
        <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 12, fontWeight: 600, color: 'rgba(255,255,255,0.7)', marginTop: 4 }}>
          {date}
        </div>
      </div>
      ...
      <div className="card-elevated" style={{ padding: '14px 18px', display: 'flex', flexDirection: 'column', justifyContent: 'center' }}>
        <div style={{ fontSize: 10, fontWeight: 800, letterSpacing: '0.16em', textTransform: 'uppercase', color: '#717971', fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', marginBottom: 10, display: 'flex', alignItems: 'center', gap: 6 }}>
          ...
          {cities.map(c => {
            ...
            return (
              <div key={c.key} style={{
                ...
                <div style={{ fontFamily: '"Manrope", -apple-system, "Segoe UI", sans-serif', fontSize: 17, fontWeight: 800, color: '#00361a', letterSpacing: '-0.02em', lineHeight: 1 }}>
